...
ms.topic: article
ms.date: 05/31/2018
ms.openlocfilehash: 1a74e78eb0c2e2a291f1d31292716a40def5a2c2
ms.sourcegitcommit: 545f2d8506531e493e4e946a9842b3c744018457
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/06/2020
ms.locfileid: "82851250"
---
...
DXGI 交换链是 Direct3D 11 和 12 中的交换链的基础。 但两者存在一些细微的差别，在 Direct3D 11 中，三种类型的交换链为 SEQUENTIAL、DISCARD 和 FLIP\_SEQUENTIAL。 Direct3D 12 只有两种类型：翻转\_顺序和翻转\_放弃。 如上所述，应通过**IDXGIFactory4**或更高版本显式创建存在，并对任何适配器枚举使用同一接口。
...
|----------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**ID3D11Query**](/windows/win32/api/d3d11/nn-d3d11-id3d11query)                                              | [**ID3D12QueryHeap**](https://msdn.microsoft.com/library/Dn891447(v=VS.85).aspx) 允许将查询分组在一起，以降低成本。                                                                                                                                                                                                                                                                                                                                     |
